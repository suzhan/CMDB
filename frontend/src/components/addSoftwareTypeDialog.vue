<template>
    <div class="addSoftwareTypeDialog" v-if="visible">
        <el-dialog
            title=""
            :visible.sync="open"
            :show-close="true"
        ...
        methods: {
            fnAddNew: function (form) {
                this.$refs[form].validate((valid) => {
                    if (valid) {
                        console.log(this.form.single_input_text);
                        axios.post('api/add_software_type', {
                        ...
                        // this.$emit('addSoftwareTypeCallback', this.form)
                    } else {
